...
public class EmailService {
    ...
    public void sendVerificationEmail(String email, String verificationToken) throws MessagingException {
        ...
        helper.setText("<html>\n" +
                ...
                + "\" style=\"color: white; text-decoration: none;\">Click here to confirm your email address</a>\n" +
                "				</div>\n" +
                ...
                "<h3 style=\"color: #333;\">Quan's store</h3>\n" +
                "			</td>\n" +
                "		</tr>\n" +
                "	</table>\n" +
                "</body>\n" +
    ...
    public MimeMessage createConfirmationMessage(Long order_id, String email) throws MessagingException {
        ...
        String contactEmail = "qpham16112003@gmail.com";
        String companyName = "Quan's store";
        ...
        String htmlMessage = "<html><body>"
                ...
                + "</tbody>"
                + "</table>"
                + "<p>If you have any questions or concerns, please don't hesitate to contact us at <a href=\"mailto:"
    ...
    private String getOrderDetails(Long order_id) {
        ...
        Order order = optionalOrder
                .orElseThrow(() -> new EntityNotFoundException("Order not found with ID: " + order_id));
